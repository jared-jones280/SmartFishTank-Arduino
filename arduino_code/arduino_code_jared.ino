...
void loop()
{
    ...
    display.println(F("Temp:"+to_String(temp)+"C"));
    display.setCursor(0, 24);
    display.println(F("Clarity:"+to_String(rand()%5));
    display.setCursor(0, 36);
    display.println(F("PH:"+to_String(analogRead(PH_SENSOR));
    display.setCursor(0,48);
    display.println(F("Set Temp:"+to_String((analogRead(POTENTIOMETER_0)/50)+60)+"C"));
    display.display();
